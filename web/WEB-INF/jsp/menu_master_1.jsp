                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item" style="margin-right: 20px">
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/staff">
                                <i class="fa fa-users" style="color:whitesmoke"></i> Data Staff</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/input/staff">
                                <i class="fa fa-user-plus" style="color:whitesmoke"></i> Input Admin Staff</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  href="${pageContext.request.contextPath}/admin/profil/${admin.getIdAdmin()}">
                                <i class="fa fa-user-circle" style="color:whitesmoke" ></i> My Profile
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/logout" onclick="return confirm('Yakin Logout ?')">
                                <i class="fa fa-power-off" style="color:whitesmoke"></i> Logout
                            </a>
                        </li>
                    </ul>
                </div>
